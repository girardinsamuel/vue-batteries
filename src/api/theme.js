...
export const useComponentClasses = (props, themeKey) => {
  ...
  let componentClasses = props.override
    ? props.classes
  ...
  const setElementClasses = (elementKey, baseKey, mapping = {}) => {
    let _classes = [componentClasses[elementKey][baseKey]]
    for (let [propKey, propValue] of Object.entries(mapping)) {
      if (propValue) {
